...
def index(request):
    ...
    if count == 1:
        ...
        return render(request, "recipe_app/index.html", {'recipes': recipes})
...
def cooker(request):
    ...
    return render(request, "recipe_app/cooker.html", {'recipes': recipes})
...
def recipe_add(request):
    ...
    if request.method == 'POST':
        ...
        is_completed = False
        form = RecipeForm()
    return render(request, 'recipe_app/recipe_add.html',
